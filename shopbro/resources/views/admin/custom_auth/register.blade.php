   ...
   <div class="w3layouts-main">
       ...
       ?>
           <form action="{{ URL::to('/register') }}" method="post">
              {{ csrf_field() }}
              <input type="text" class="ggg" name="admin_name"  vaule="{{ old('admin_name') }}" placeholder="Nhập tên" required="">
